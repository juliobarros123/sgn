...
?>
    ...
    <script type="text/javascript">
        ...
        var turmas = [
            @foreach ($Anosgraficos as $value)
                 @php $d = Turma::where([['vc_anoLectivo', "$value->ya_inicio-$value->ya_fim"]])->count(); echo $d; @endphp, 
            @endforeach
    ...
    <script type="text/javascript">
        ...
        var candidaturas = [
            @foreach ($Anosgraficos as $value)
                 @php $d = Candidatura::where([['vc_anoLectivo', "$value->ya_inicio-$value->ya_fim"]])->count(); echo $d; @endphp, 
            @endforeach
    ...
    <script type="text/javascript">
        ...
        var matriculados = [
            @foreach ($Anosgraficos as $value)
                 @php $d = Matricula::where([['vc_anoLectivo', "$value->ya_inicio-$value->ya_fim"]])->count(); echo $d; @endphp, 
            @endforeach
        ...
        var selecionados = [
            @foreach ($Anosgraficos as $value)
                 @php $d = Alunno::where([['vc_anoLectivo', "$value->ya_inicio-$value->ya_fim"]])->count(); echo $d; @endphp, 
            @endforeach
    ...
    <script>
        ...
        var cursodadosanoactual = [
            @foreach ($Cursosgraficos as $raw)
                 @php $s =  Candidatura::where([['vc_anoLectivo', $AnoLectivo], ['vc_nomeCurso', $raw->vc_nomeCurso]])->orderBy('vc_nomeCurso', 'asc')->count(); echo $s; @endphp, 
            @endforeach
